...
## Operational Rules
0. **Check Configuration:** Use `get_sauver_config` to retrieve the user's preferences. If `treat_unsolicited_investors_as_slop` is `false`, treat this email as legitimate and stop — do not deploy any trap.
