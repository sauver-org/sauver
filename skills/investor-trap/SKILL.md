...
## Operational Rules
0. **Check Configuration:** Use `get_sauver_config`. If `treat_unsolicited_investors_as_slop` is `false`, treat the email as legitimate and stop — do not deploy any trap.
