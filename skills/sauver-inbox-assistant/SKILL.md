...
0. **Check Configuration:** Use the `get_sauver_config` tool to retrieve the user's automation preferences (e.g., `yolo_mode`, `auto_draft`, `treat_job_offers_as_slop`, `treat_unsolicited_investors_as_slop`).
