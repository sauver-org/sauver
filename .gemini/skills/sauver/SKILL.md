...
Use your Read tool to load `skills/sauver-inbox-assistant/SKILL.md` and `skills/PROTOCOL.md`, then follow the instructions in that file exactly.

All tools listed in `skills/PROTOCOL.md` are available via the Sauver MCP server (`mcp__sauver__*`). No substitution needed.
